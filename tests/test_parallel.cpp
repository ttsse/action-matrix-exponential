...
int main(int argc, char **argv) {
    ...
    PetscPrintf(PETSC_COMM_WORLD, "Time ellapsed with %d processes = ", size);
    PetscPrintf(PETSC_COMM_WORLD, "%0.3f",(double)(std::chrono::duration_cast<std::chrono::milliseconds>(end - begin).count())/1000);
